...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
	...
	{
	?>
	<a class="navbar-brand" style="color:black; text-decoration:none;"><i class="far fa-user">&nbsp;&nbsp;<b><?php if(isset($id)) { echo $vr['fld_name']; }?></b></i></a>
	<?php
	}
	?>
	...
	<!--tab 1 starts-->   
	   <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="viewitem" role="tabpanel" aria-labelledby="home-tab">
			 ...
			 <th><center>Update item Details</center></th>
			 <th><center>Delete Item</center></th>
			   ...
			   <?php
				...
				<a href="update.php?food_id=<?php echo $row['food_id'];?>"><button type="button" class="btn btn-warning">Update </button></a>
				</td>
				<td align="center" style="width:150px;">
				<a href="vendor_delete_food.php?food_id=<?php echo $row['food_id'];?>"><button type="button" class="btn btn-danger">Delete </button></a>
				</td>
				</tr>
...
<!--tab 1 ends-->	   
			...
			<div class="tab-pane fade" id="logo" role="tabpanel" aria-labelledby="logo-tab">
			 ...
			 <div class="tab-pane fade " id="status" role="tabpanel" aria-labelledby="status-tab">
			   ...
			   ?>
						<form method="post">
						<td><a href="changestatus.php?order_id=<?php echo $orderrow['fld_order_id']; ?>"><button type="button" name="changestatus" class="btn btn-warning">Update Status</button></a></td>
						</form>
						<tr>
						<?php
					}
