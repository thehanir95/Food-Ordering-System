  ...
  <div class="row">
    <div class="col-sm-8" style="padding:20px; border:1px solid #F0F0F0;">
	    <form method="post">
			...
			<div class="form-group">
			<center>
			<button type="submit" name="message" class="btn btn-success">Send Message</button>
			</center>
            </div>
        </form>
	</div>
    <div class="col-sm-4" style="padding:30px;">
	   <div class="form-group">
            <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>0112000000</b><br><br>
			<i class="fa fa-home" aria-hidden="true"></i>&nbsp; <b>No:8, Galagama, Belihuloya <br>(24*7 Days) </b>
