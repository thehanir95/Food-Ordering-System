      ...
      <ul class="navbar-nav ml-auto">
		...
		<li class="nav-item">
          ...
          <?php
			...
			{
			?>
			<a href="cart.php"><span style=" color:black; font-size:30px;"><i class="fa fa-shopping-cart" aria-hidden="true"><span style="color:green;" id="cart"  class="badge badge-light"><?php if(isset($re)) { echo $re; }?></span></i></span></a>
...
<div class="tab-content" id="myTabContent">
	...
	?>			
                    <tr>
						<td style=text-align:center;><img src="../image/restaurant/<?php echo $row['fld_email']."/foodimages/" .$row['fldimage'];?>" height="50px" width="100px"></td>
						...
						<form method="post">
		               <td style=text-align:center;><button type="submit" name="addtocart" value="<?php echo $row['food_id'];?>" class="btn btn-success">Order</button></td>
						</form>
                   </tr>
		<?php
		}
