...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
	...
	{
	?>
	<a class="navbar-brand" style="color:black; text-decoratio:none;"><i class="far fa-user"> &nbsp;&nbsp;<b>Admin</b></i></a>
	<?php
	}
	?>
...
<div class="container">
	...
	<!--tab 1 starts-->   
	   <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="viewitem" role="tabpanel" aria-labelledby="viewitem-tab">
                 ...
                 <thead>
                    <tr>
					        <th scope="col" style=text-align:center;>Food Cabin Name</th>
                            <th scope="col" style=text-align:center;>Food View</th>
                            <th scope="col" style=text-align:center;>Food Ingredians</th>
                            <th scope="col" style=text-align:center;>Food Name</th>
                            <th scope="col" style=text-align:center;>Remove Food Cabin</th>
                     </tr>
                 </thead>
				 <tbody>
	<?php
	...
	?>			 
                    ...
                    <tr>
					    <td style=text-align:center;><?php echo $row['fld_name'];?></td>
						<td style=text-align:center;><img src="image/restaurant/<?php echo $row['fld_email']."/foodimages/" .$row['fldimage'];?>" height="50px" width="100px">
						<br>
						</td>
						<td style=text-align:center;><?php echo $row['cuisines'];?></td>
                        <td style=text-align:center;><?php echo $row['foodname'];?></td>
                                               
						<form method="post">
                        <td style=text-align:center;><a href=""><button type="submit" value="<?php echo $row['food_id']; ?>" name="delete"  class="btn btn-danger">Remove </button></td>
                        </form>
                   </tr>
		<?php
		}
...
<!--tab 1 ends-->	   
			...
			<!--tab 2 ends-->
			 ...
			 <div class="tab-pane fade show" id="ManageVendors" role="tabpanel" aria-labelledby="ManageVendors-tab">
			    <div class="container">
                 ...
                 <thead>
                    <tr>
                            <th scope="col" style=text-align:center;>Food cabin logo</th>
	...
	?>			 
                    <tr>
						<td style=text-align:center;><img src="image/restaurant/<?php echo $row['fld_email']."/" .$row['fld_logo'];?>" height="50px" width="100px"></td>
						<td style=text-align:center;><?php echo $row['fld_name'];?></td>
						<td style=text-align:center;><?php echo $row['fld_address'];?></td>
						<form method="post">
                        <td style=text-align:center;><a href="#"  style="text-decoration:none; color:white;" onclick="delRecord(<?php echo $row['fldvendor_id']; ?>)"><button type="button" class="btn btn-danger">Remove Vendor</a></a></td>
                        </form>
                   </tr>
		<?php
		}
		?>		   
			 ...
			 <div class="tab-pane fade" id="orderstatus" role="tabpanel" aria-labelledby="orderstatus-tab">
			   ...
			   ?>
			   <tr>
			   <td style=text-align:center;><?php echo $rrr['fld_order_id']; ?></td>
			   <td style=text-align:center;><a href="searchfood.php?food_id=<?php echo $rrr['fld_food_id']; ?>"><?php echo $rrr['fld_food_id']; ?></td>
			   <td style=text-align:center;><?php echo $rrr['fld_email_id']; ?></td>
			   <?php
			   if($stat=="cancelled" || $stat=="Out Of Stock")
			   {
			   ?>
			   <td style=text-align:center;><i style="color:orange;" class="fas fa-exclamation-triangle"></i>&nbsp;<span style="color:red;"><b><?php echo $rrr['fldstatus']; ?></b></span></td>
			   <?php
			   }
			   else
			   {
			   ?>
			   <td style=text-align:center;><span style="color:green;"><b><?php echo $rrr['fldstatus']; ?></b></span></td>
			   <?php
			   }
			   ?>
